...
class World(object):
    """World class to set up an instance of a carla world class."""
...
class CollisionSensor(object):
    """Sensor class for collision detection."""
...
class LaneInvasionSensor(object):
    """Sensor class for lane invation."""
    def __init__(self, parent_actor, hud):
        self.sensor = None
        self._parent = parent_actor
        self.hud = hud
...
class CameraManager(object):
    """Camera manager class to handle camera settings for the visulalization."""
...
def main():
    """Main function to run the simulation loop interacting with Carla simulation engine."""
